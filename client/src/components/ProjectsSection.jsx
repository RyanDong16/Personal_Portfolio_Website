...
const projects = [
    ...
    },
    {
        ...
        description: "Designed and developed the official website for the short film Not One of Us, creating a dark, cinematic React/Vite experience that reflects the film’s crime-thriller tone. The site features custom responsive layouts, cast and crew pages, a dynamic gallery, embedded video content, animated film stills, and branded visuals tailored to the project’s identity.",
    ...
    },
    {
        ...
        description: "Developed the official website for the comedy short film Front Row, creating a clean, engaging digital home that reflects the film’s personality and style. The site highlights the film’s story, crew, cast, awards, credits, gallery, and promotional materials through a responsive React/Vite design tailored for audiences, festivals, and industry viewers.",
        ...
        <section id="projects" className="py-24 px-4 relative">
            <div className="container mx-auto max-w-5xl">
                ...
                <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                    ...
                    attention to detail, creativity, and performance.
                </p>
